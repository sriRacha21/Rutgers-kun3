...
const apiKeys = fs.existsSync(apiKeysPath) ? JSON.parse(fs.readFileSync(apiKeysPath, defaults.encoding)) : { token: 'NjcwMjk4ODEzMjg5OTg4MTE3.XisWag.wKO8OPJla-cPKud1o_xXQt-q8B4' };
